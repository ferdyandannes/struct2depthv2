...
HEIGHT = 128
STEPSIZE = 1
INPUT_DIR = '/home/ee401_2/ferdyan_train/data/kitti_one_obj_raw'
OUTPUT_DIR = '/home/ee401_2/ferdyan_train/data/processedv4/'
...
for d in glob.glob(INPUT_DIR + '/*/'):
    ...
    for d2 in glob.glob(d + '*/'):
        ...
        for subfolder in ['image_02_new/data', 'image_03_new/data']:
            ct = 1
            ...
            print('')
            print('')
            print('aaaaaaaaaaaaaaaaaaaaa = ', seqname2)
            print('')
            print('')
            print('')
            if not os.path.exists(OUTPUT_DIR + seqname2):
                seqname2 = seqname[:-4]
                os.mkdir(OUTPUT_DIR + seqname2)
            ...
            for i in range(SEQ_LENGTH, len(files)+1, STEPSIZE):
                ...
                if os.path.exists(OUTPUT_DIR + seqname2 + '/' + imgnum + '.png'):
                    ct+=1
                    continue
